...
export const ui = {
  es: {
    ...
    // Experience: Tutor
    'exp.tutor.title': 'Tutor del curso de hacking con PHP.',
    ...
    'proj.rustsdk.f1': '<strong>Core & Criptografía:</strong> Implementación de verificación de pruebas <strong>ROLA</strong> (Login con Radix), manejo de claves (Keystore) y construcción de transacciones.',
  ...
  en: {
    ...
    'proj.rustsdk.f1': '<strong>Core & Cryptography:</strong> Implementation of <strong>ROLA</strong> proofs verification (Login with Radix), key management (Keystore), and transaction building.',
